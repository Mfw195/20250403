...
% save('./model_data./alpha_distribution.mat','alpha_p') ;
% save('./model_data./phy_c_distribution.mat','phy_k') ;
% save('./model_data./press.mat','press_pp') ;
% save('./model_data./K_dry.mat','K_d') ;
% save('./model_data./u_dry.mat','um_d') ;
